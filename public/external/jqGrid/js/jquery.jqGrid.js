...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		addMulti = function(rowid,pos,irow,checked){
			// 20190611 custom
			var	v = "<label class='checkbox'><input role=\"checkbox\" type=\"checkbox\""+" id=\"jqg_"+ts.p.id+"_"+rowid+"\" class=\"cbox\" name=\"jqg_"+ts.p.id+"_"+rowid+"\"" + (checked ? "checked=\"checked\"" : "")+"/><i></i></label>",
		...
		if(this.p.multiselect) {
			// 20190611 custom
			this.p.colNames.unshift("<label class='checkbox'><input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/><i></i></label>");
		...
		if(rdata) {
			...
			this.each(function() {
				...
				while(k < datalen) {
					...
					if(gi) {
						// 20190611 custom
						v = "<label class='checkbox'><input role=\"checkbox\" type=\"checkbox\""+" id=\"jqg_"+t.p.id+"_"+rowid+"\" class=\"cbox\"/><i></i></label>";
