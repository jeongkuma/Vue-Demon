...
g.formatter.call(d,c,b,f,h):a.fmatter?a.fn.fmatter.call(d,g.formatter,c,b,f,h):n(c)):c=n(c);return c},u=function(a,d,b,c,e,f){d=t(a,d,b,e,"add");return'<td role="gridcell" '+q(b,c,d,e,a,f)+">"+d+"</td>"},w=function(a,b,c,e){e='<label class="checkbox"><input role="checkbox" type="checkbox" id="jqg_'+d.p.id+"_"+a+'" class="cbox" name="jqg_'+d.p.id+"_"+a+'"'+(e?'checked="checked"':"")+"/><i></i></label>";return'<td role="gridcell" '+q(b,c,"",null,a,!0)+">"+e+"</td>"},s=function(a,d,b,c){b=(parseInt(b,10)-1)*parseInt(c,10)+1+d;return'<td role="gridcell" class="ui-state-default jqgrid-rownum" '+
...
d.p.datatype&&(d.p.localReader={id:"_id_"})}if(this.p.subGrid)try{a(d).jqGrid("setSubGrid")}catch(N){}this.p.multiselect&&(this.p.colNames.unshift("<label class='checkbox'><input role='checkbox' id='cb_"+this.p.id+"' class='cbox' type='checkbox'/><i></i></label>"),this.p.colModel.unshift({name:"cb",width:a.jgrid.cell_width?d.p.multiselectWidth+d.p.cellLayout:d.p.multiselectWidth,sortable:!1,resizable:!1,hidedlg:!0,search:!1,align:"center",fixed:!0}));this.p.rownumbers&&(this.p.colNames.unshift(""),this.p.colModel.unshift({name:"rn",width:d.p.rownumWidth,
...
p&&(n=this.formatCol(0,1,"",null,b,!0),h[h.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n+">0</td>");k&&(q='<label class="checkbox"><input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+b+'" class="cbox"/><i></i></label>',n=this.formatCol(p,1,"",null,b,!0),h[h.length]='<td role="gridcell" '+n+">"+q+"</td>");l&&(h[h.length]=a(this).jqGrid("addSubGridCell",k+p,1));for(r=k+l+p;r<this.p.colModel.length;r++)x=this.p.colModel[r],d=x.name,D[d]=s[d],q=this.formatter(b,a.jgrid.getAccessor(s,d),r,s),n=this.formatCol(r,
